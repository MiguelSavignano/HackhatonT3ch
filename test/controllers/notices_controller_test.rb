...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { city_id: @notice.city_id, description: @notice.description, rating: @notice.rating, title: @notice.title }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { city_id: @notice.city_id, description: @notice.description, rating: @notice.rating, title: @notice.title }
    assert_redirected_to notice_path(assigns(:notice))
  end
